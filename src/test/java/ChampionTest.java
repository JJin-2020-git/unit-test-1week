...
//        List<String> emptyList = new ArrayList<>();
        List<String> empryList = new ArrayList<>();
        assertThat(empryList, empty());
...
//        assertThat(3.14, closeTo(3, 0.2));
    ...
    //anything 테스트 -> anything() 어떤 값이어도 상관이 없다
    @Test
...
//        assertThat("타릭", equalTo(supportChamp.getName()));
    ...
    //hasToString 활용 테스트 일부 포함 안되고 전체 다 갖고 있어야함
    @Test
    public void shouldHaveSomeChampName() {
        ...
        List<String> members = Arrays.asList("진", "정국", "rm");
        assertThat(members.get(0), hasToString("진"));
    }
